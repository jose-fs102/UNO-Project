...
public:
	...
	/* TODO Lab2:
			...
			*/
	Player(const char* _name = "Player", int _maxCards = 31);
	...
	*/
	...
	// cheat accessor
	unsigned char GetCheat() const { return cheat; };
	...
	// Mutator for the cheat
	void SetCheat(unsigned char _cheat);
